...
- Only crawl URLs matching `https://code.claude.com/docs/en/**`
- Only crawl text-based content (e.g., markdown or plain text)
...
- Keep JSON file insde the content folder with metadata the craw execution. Use the following structure:
```json
{
  "seedUrl": "https://code.claude.com/docs/llms.txt",
  "scopePrefix": "https://code.claude.com/docs/en/",
  "lastUpdate": "2026-02-01T12:00:00Z",
  "result": "success", // "success", "partial", "aborted"
  "stats": {
    "uniqueUrls": 47,
  ...
  "items": {
      "overview.md": {
          ...
          "statusReason": "new", // "new", "changed", "unchanged", "removed", "httpError", "outOfScope", "duplicate", "redirectOutOfScope", "redirectDuplicate"
          "fetchedAt": "2026-02-01T12:00:00Z",
      },
      "best-practices.md": {
          "status": "failed",
          "statusReason": "httpError",
          "fetchedAt": "2026-02-01T12:01:00Z",
      },
      "http://url-out-of-scope.com/page": {
          "status": "skipped",
          "statusReason": "outOfScope",
          "fetchedAt": "2026-02-01T12:02:00Z",
      }
      //...
  }
}
